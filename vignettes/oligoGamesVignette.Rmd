...
Next, we go from oligo counts to nucleotide counts. Each nucleotide is tiled by several different oligos and hence we can use different approaches to model nucleotide counts from the corresponding oligo counts. A simple approach might be 
...
DRregions <- DRfinder(modeledNucs, conditionLabels, minInSpan = 5, bpSpan = 50, 
                      minNumRegion = 3, cutoff = 0.05, smooth = TRUE, verbose = TRUE, 
