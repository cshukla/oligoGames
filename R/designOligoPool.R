...
#' @param barcodeLen numeric describing the length of the barcode. Default value
#'   is 10
...
designOligoPool <- function(regionsFile, tileSize=110, overlap=10, barcodesPerSequence=1, 
  ...
  python.call("designOligoPool", regionsFile, tileSize, overlap, barcodesPerSequence, barcodesFile, univPrimers, reSeq, microSeedsFile, badNucs, numScrambles, barcodeLen, outDir)
}
